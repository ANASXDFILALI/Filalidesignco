...
const blindTypes = imagesData.curtains.blinds;
const curtainImages = imagesData.curtains;
                ...
                <div className="flex gap-8 w-max px-2">
                    {blindTypes.map((blind, idx) => (
                        ...
                        >
                            ...
                            <p className="font-elegant text-riad-white/70 text-lg leading-relaxed border-l border-riad-gold/30 pl-4">
                                {blind.desc}
                            </p>
                        </motion.div>
                    ))}
