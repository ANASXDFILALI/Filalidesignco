...
const bedModels = imagesData.beds.models;
const bedFeatured = imagesData.beds.featured;
                ...
                <div className="flex gap-8 w-max px-2">
                    {bedModels.map((model, idx) => (
                        ...
                        >
                            ...
                            <p className="font-elegant text-riad-brown/70 text-lg leading-relaxed border-l border-riad-gold pl-4">
                                {model.desc}
                            </p>
                        </motion.div>
                    ))}
