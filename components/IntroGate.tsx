      ...
      {!isOpen && (
        <div className="fixed inset-0 z-[100] flex justify-center items-center overflow-hidden perspective-[2000px]">
          ...
          <motion.div
            ...
            className="absolute z-40 bg-white shadow-[0_0_100px_20px_rgba(255,215,0,0.8)] pointer-events-none"
          />
          ...
          <motion.div
            ...
            className="w-1/2 h-full bg-riad-blue relative shadow-2xl border-r border-riad-gold/40 z-20 flex items-center justify-end"
          >
             {/* Texture & Gradients */}
            ...
            {/* Inner Gold Trim */}
            <div className="absolute top-10 bottom-10 right-10 left-10 border border-riad-gold/20" />
            <div className="absolute top-12 bottom-12 right-12 left-12 border border-riad-gold/10" />

            {/* Handle/Knocker Base Left */}
            <div className="absolute right-0 top-1/2 -translate-y-1/2 w-32 h-64 bg-riad-blue border-l-2 border-t-2 border-b-2 border-riad-gold/60 rounded-l-full overflow-hidden mr-[-1px]">
          ...
          <motion.div
            ...
            className="w-1/2 h-full bg-riad-blue relative shadow-2xl border-l border-riad-gold/40 z-20 flex items-center justify-start"
          >
             {/* Texture & Gradients */}
            <div className="absolute inset-0 opacity-100 bg-riad-blue" />
            <div className="absolute inset-0 opacity-40" style={{ backgroundImage: `url("${doorPattern}")` }} />
            ...
            <div className="absolute top-12 bottom-12 right-12 left-12 border border-riad-gold/10" />
             ...
             <div className="absolute left-0 top-1/2 -translate-y-1/2 w-32 h-64 bg-riad-blue border-r-2 border-t-2 border-b-2 border-riad-gold/60 rounded-r-full overflow-hidden ml-[-1px]">
                 <div className="absolute inset-0 opacity-30" style={{ backgroundImage: `url("${doorPattern}")` }} />
                 <div className="absolute inset-0 bg-black/40" />
            </div>
          </motion.div>
          ...
          >
             <div className="relative w-48 h-48 flex items-center justify-center">
                ...
                {/* The "Knocker" Button */}
                <div className="relative w-32 h-32 bg-gradient-to-br from-riad-blue to-black rounded-full border border-riad-gold-light shadow-2xl flex flex-col items-center justify-center overflow-hidden group">
